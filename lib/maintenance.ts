...
export const FRONTEND_MAINTENANCE_MESSAGE = "Please wait while server undergoing maintainence";
export const ADMIN_LOGIN_MAINTENANCE_MESSAGE = "database server outdated, wait for maintainence";
